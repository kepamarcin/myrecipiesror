...
class RecipesTest < ActionDispatch::IntegrationTest
  ...
  def setup
    @chef = Chef.create!(chefname: "marcin123", email: "marcin123@gmail.com")
    # @recipe = Recipe.create(name: "vegetable soup", description: "good vegetable soup", chef: @chef)
    # @recipe2 = Recipe.create(name: "chicken soup", description: "good chicken soup", chef: @chef)
  ...
  test "create new valid recipe" do
    ...
    description_of_recipe = "good chicken soup"
  ...
  test "create invalid recipe submissions" do
    get new_recipe_path
    assert_template "recipes/new"
